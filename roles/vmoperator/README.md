...
```YAML
vmoperator_chart_version: 0.67.2
```
...
```YAML
vmoperator_default_rules_chart_version: 0.91.2
```
...
```YAML
vmoperator_vmalert_image_tag: v1.150.0
```
...
```YAML
vmoperator_vmalertmanager_image_tag: v0.34.0
```
...
```YAML
vmoperator_vmauth_image_tag: v1.151.0
```
