...
```YAML
vmoperator_chart_version: 0.67.1
```
...
```YAML
vmoperator_default_rules_chart_version: 0.87.0
```
...
```YAML
vmoperator_vmalert_image_tag: v1.149.0
```
...
```YAML
vmoperator_vmalertmanager_image_tag: v0.33.1
```
...
```YAML
vmoperator_vmauth_image_tag: v1.148.0
```
