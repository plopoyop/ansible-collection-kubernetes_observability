...
| ---------       | ------------------ | --------------------------------------------- | ------------------------------------        |
| grafana | v12.10.0      | `grafana`                                     | [View README](roles/grafana/README.md) |
| jaeger | v4.12.0      | `jaeger`                                      | [View README](roles/jaeger/README.md) |
| opentelemetry k8s stack | v0.19.2      | `opentelemetry`                               | [View README](roles/opentelemetry/README.md) |
| loki | v18.7.1      | `loki`                                        | [View README](roles/loki/README.md) |
| victoriametrics single | v0.43.0      | `victoriametrics` / `victoriametrics_single`  | [View README](roles/victoriametrics/README.md) |
| vmagent | v0.44.0      | `victoriametrics` / `victoriametrics_vmagent` | [View README](roles/victoriametrics/README.md) |
| victorialogs single | v0.13.9      | `victorialogs`                                | [View README](roles/victorialogs/README.md) |
| vmoperator | v0.66.3      | `vmoperator` / `vmoperator_operator`          | [View README](roles/vmoperator/README.md) |
| vm default rules | v0.87.0      | `vmoperator_default_rules`                    | [View README](roles/vmoperator/README.md) |
