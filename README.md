...
| ---------       | ------------------ | --------------------------------------------- | ------------------------------------        |
| grafana | v13.2.1      | `grafana`                                     | [View README](roles/grafana/README.md) |
...
| victoriametrics single | v0.46.0      | `victoriametrics` / `victoriametrics_single`  | [View README](roles/victoriametrics/README.md) |
