...
| ---------       | ------------------ | --------------------------------------------- | ------------------------------------        |
| grafana | v12.11.2      | `grafana`                                     | [View README](roles/grafana/README.md) |
| jaeger | v4.12.0      | `jaeger`                                      | [View README](roles/jaeger/README.md) |
| opentelemetry k8s stack | v0.20.3      | `opentelemetry`                               | [View README](roles/opentelemetry/README.md) |
| loki | v18.11.2      | `loki`                                        | [View README](roles/loki/README.md) |
| victoriametrics single | v0.44.0      | `victoriametrics` / `victoriametrics_single`  | [View README](roles/victoriametrics/README.md) |
| vmagent | v0.46.0      | `victoriametrics` / `victoriametrics_vmagent` | [View README](roles/victoriametrics/README.md) |
| victorialogs single | v0.13.9      | `victorialogs`                                | [View README](roles/victorialogs/README.md) |
| vmoperator | v0.67.2      | `vmoperator` / `vmoperator_operator`          | [View README](roles/vmoperator/README.md) |
| vm default rules | v0.91.2      | `vmoperator_default_rules`                    | [View README](roles/vmoperator/README.md) |
