...
| ---------       | ------------------ | --------------------------------------------- | ------------------------------------        |
| grafana | v13.2.2      | `grafana`                                     | [View README](roles/grafana/README.md) |
| jaeger | v4.13.1      | `jaeger`                                      | [View README](roles/jaeger/README.md) |
| opentelemetry k8s stack | v0.20.8      | `opentelemetry`                               | [View README](roles/opentelemetry/README.md) |
...
| vmagent | v0.47.0      | `victoriametrics` / `victoriametrics_vmagent` | [View README](roles/victoriametrics/README.md) |
...
| vm default rules | v0.92.1      | `vmoperator_default_rules`                    | [View README](roles/vmoperator/README.md) |
