...
| ---------       | ------------------ | --------------------------------------------- | ------------------------------------        |
| grafana | v13.2.0      | `grafana`                                     | [View README](roles/grafana/README.md) |
| jaeger | v4.12.0      | `jaeger`                                      | [View README](roles/jaeger/README.md) |
| opentelemetry k8s stack | v0.20.6      | `opentelemetry`                               | [View README](roles/opentelemetry/README.md) |
| loki | v18.11.7      | `loki`                                        | [View README](roles/loki/README.md) |
...
| vmoperator | v0.67.3      | `vmoperator` / `vmoperator_operator`          | [View README](roles/vmoperator/README.md) |
